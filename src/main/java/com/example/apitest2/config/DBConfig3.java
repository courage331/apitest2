...
@Slf4j
@Configuration
@EnableJpaRepositories(basePackages = "com.example.apitest2.repository.my", entityManagerFactoryRef = "apiEntityManager3", transactionManagerRef = "apiTransactionManager3")
public class DBConfig3 {
	@Autowired
	private Environment env;

	private static final String prefix = "spring.test3.datasource.";

	@Bean(name = "apiEntityManager3")
	@Primary
	...
	@Bean(name = "apiTransactionManager3")
	@Primary
